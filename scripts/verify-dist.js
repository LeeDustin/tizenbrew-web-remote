...
for (const requiredId of ['pairForm', 'remoteView', 'toggleAllSections', 'showTvOverlay', 'hideTvOverlay', 'profiles', 'bilibiliPanel', 'bilibiliResultsPanel', 'bilibiliResults', 'bilibiliQuality', 'danmakuButton', 'fillTvButton', 'touchMode', 'touchpad', 'dpadPanel', 'playerPanel', 'seekStep', 'pageItems', 'forgetButton']) {
